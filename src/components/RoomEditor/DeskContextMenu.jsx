...
export default function DeskContextMenu({
  ...
  return (
    ...
    >
      <li className="menu-title py-1 px-2 text-[10px] uppercase opacity-50 text-base-content/60">Makkergrupper</li>
      ...
      <li><a onClick={() => { clearGroupForSelected(); setContextMenu(null); }}><i className="fa-solid fa-object-ungroup text-base-content/60"></i> Fjern fra gruppe</a></li>
      ...
      <div className="divider my-0 h-1"></div>
      <li className="menu-title py-1 px-2 text-[10px] uppercase opacity-50 text-base-content/60">Handlinger</li>
